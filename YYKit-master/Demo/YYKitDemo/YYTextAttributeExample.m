...
- (void)viewDidLoad {
    ...
    
    {
        ...
        border.strokeColor = [UIColor colorWithRed:1.000 green:0.029 blue:0.651 alpha:1.000];  //边框的颜色
        border.strokeWidth = 3;  //边框的厚度
        border.lineStyle = YYTextLineStylePatternCircleDot;  //边框的样式
        border.cornerRadius = 3;  //边框弯角的半径
        border.insets = UIEdgeInsetsMake(0, -4, 0, -4);  //边框的内边距
    ...
    
    {
        ...
        one.font = [UIFont boldSystemFontOfSize:30];
        one.underlineStyle = NSUnderlineStyleSingle;  //下划线
...
//            border.fillColor = [UIColor colorWithWhite:0.000 alpha:0.220];  //高亮时候边框内部的填充颜色
//
...
//        innerShadow0.color = [UIColor colorWithRed:0.851 green:0.311 blue:0.000 alpha:0.780];
        innerShadow0.color = [UIColor blueColor];
        innerShadow0.offset = CGSizeMake(0, 1);
        innerShadow0.radius = 1;
        
        YYTextHighlight *highlight = [YYTextHighlight new];
        [highlight setColor:[UIColor brownColor]];
