...
////////////////////////////////////////////////////////////////////////////////
#pragma mark ————— Model的属性名和JSON中的Key不相同 —————
...
//返回一个Dict，将Model的属性名映射到JSON的Key上
...
/**
 * 当JSON转Model完成后，该方法会被调用；
 * 可以在这里对数据进行校验，如果校验不通过，可以返回NO，则该Model会被忽略；
 * 也可以在这里对数据进行校验，如果校验不通过，可以返回NO，则该Model会被忽略。
 */
